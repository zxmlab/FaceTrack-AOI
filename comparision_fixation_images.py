...
def evaluate_fixation_regions(df, csv_table, imagecolumn):
...
def process_fixation_image(input_txt_path, csvtable_path, imagecolumn, output_path=None):
    ...
    df = evaluate_fixation_regions(df, csv_table, imagecolumn)
